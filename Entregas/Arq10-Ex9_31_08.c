// MICAP T01 2023/2
// Arq10-Ex09 (31/08/2023)
// Escrito por Isadora S. Silva
...
void main(void) {
	...
	printf_fast_f("\x01 isadora silva");

	printf_fast_f("\x02 isadora silva");
	printf_fast_f("\x03 isadora silva");
	printf_fast_f("\x04 isadora silva");
	printf_fast_f("\x05 isadora silva");
	printf_fast_f("\x06 isadora silva");
	printf_fast_f("\x07 isadora silva");
	printf_fast_f("\x08 isadora silva");
